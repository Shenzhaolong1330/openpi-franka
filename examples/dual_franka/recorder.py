...
class Recorder:
    """This class handles asynchronous logging and visualization for dual franka (3 cameras)."""
    ...
    def _visualizer_thread(self):
        ...
        while True:
            try:
                ...
                l_wrist, ext, r_wrist = map(self.to_bgr, [obs["observation/wrist_image"], obs["observation/image"], obs["observation/right_wrist_image"]])
    ...
    # ====================== Save Video ====================== #
    def save_video(self):
        """Save stored frames as three separate MP4 videos using H.264."""
    ...
    def save_videos_multi_codec(self):
        """Save frames in memory as videos with H.264 / H.265 / AV1 (3 cameras)."""
